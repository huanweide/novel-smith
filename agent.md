...
| 最新 Release | `v3.1.123 接口安全第四轮收口 + 首页 hydration 修复：generation-metrics 错误响应脱敏、ProjectCard 时间渲染确定性化（SEC-LEAK-GENMETRICS / FIX-HYDRATION-418）`（2026-09-11，Latest） |
