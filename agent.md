...
| 最新 Release | `v3.1.126 表单标签横扫（二轮）：项目设置 / 生成确认 / 一致性录入补齐字段标签与可访问名，并修复 Json 数组字段保存必 400（FORM-LABEL-SWEEP / PATCH-ARRAY-400）`（2026-09-12，Latest） |
